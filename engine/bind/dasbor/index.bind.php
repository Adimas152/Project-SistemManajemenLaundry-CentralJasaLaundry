...
<head>
    ...
    <title>Laundry Central Jasa - Dashboard</title>
...
<body style="font-family: 'Nunito Sans';">
    ...
    <div id="app">
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="#!" style='height:30px;'>
                            <img src='<?= STYLEBASE; ?>/dasbor/img/logo_laundry.png' style="width: 100px;">
                        </a>
                    </div>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 id='capUtama'> Central Jasa Laundry - {{judulForm}}</h1>
                    </div>
                    <div class="progress mb-3" data-height="5" style="height: 5px;" id='divProgress'>
                        <div id='loaderEksis' class="progress-bar" role="progressbar" data-width="0%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 0%;">
                        </div>
                    </div>
                    <div id="divUtama"></div>
                </section>
        ...
        <footer class="main-footer" id='divFooter'>
            Copyright &copy; {{tahun}} - Central Jasa Laundry
        </footer>
        <!-- General JS Scripts -->
